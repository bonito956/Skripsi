            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h1 class="m-0">Data Informasi Burung</h1>
                    </div><!-- /.container-fluid -->
                </div>
                <!-- /.content-header -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <?php
                                            foreach($data_info as $index => $value){
                                        ?>
                                        <tbody>
                                            <tr data-widget="expandable-table" aria-expanded="false">
                                                <td><?php echo $value['nama_burung'] ?></td>
                                                <td><?php echo $value['habitat_burung'] ?></td>
                                                <td><img src="assets/uploads/burung/<?php echo $value['foto']; ?>" width="85px" height="85px"></td>
                                                
                                                <td>
                                                    <a href="hapus_info.php?id_info=<?php echo $value['id_info'] ?>" type="button"> 
