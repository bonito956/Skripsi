...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="background-color: #2B2B2B; font-family: 'Franklin Gothic Medium';">
            ...
            <li><a href="menu_info.php" style="color: #80AB82">Info</a></li>
            <li><h6 style="color: #2B2B2B">...</h6></li>
            <li><i class="fas fa-angle-right mr-3" style="color: white;"></i></li>
            <?php
                $tampil = "SELECT * FROM info where id_info='".$_GET['id']."'";
                $sql = mysqli_query ($conn,$tampil);
                while($data = mysqli_fetch_array ($sql)){
            ?>
            <li><a style="color: white"><?php echo $data['nama_burung']; ?></a></li>
            <?php
                }
            ?>
        </ol>
    ...
    <div class="container">
        <div class="col text-left"> 
            ...
            <?php
                ...
                while($data = mysqli_fetch_array ($sql)){
            ?>
            <h2 class="text-center"><?php echo $data['nama_burung']; ?></h2>

            <hr>
            <img src="assets/uploads/burung/<?php echo $data['foto']; ?>" style=" display: block; margin-left: auto; margin-right: auto; max-width: 100%; height: auto;">
            <hr>
            <p><i class="fa fa-tree"> <?php echo $data['habitat_burung']; ?></i></p>
