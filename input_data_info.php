            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h1 class="m-0">Tambah Data Informasi Burung</h1>
                    </div><!-- /.container-fluid -->
                </div>
                <!-- /.content-header -->
                ...
                <div class="content">
                    <div class="container">
                        <div class="col-12">
                            <form class="form-horizontal" data-toggle="validator" role="form" method="post" action="simpan_info.php"  enctype="multipart/form-data">
                                <div class="form-group has-feedback">
                                    <p><b>Nama Burung:</b></p>
                                    <div class="col-md-15">
                                        <input type="text" class="form-control" required name="nama_burung" id="nama_burung" data-error="Isi data dengan benar">
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        <div class="help-block with-errors" role="alert"></div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <p><b>Habitat Burung:</b></p>
                                    <div class="col-md-15">
                                        <input type="text" class="form-control" required name="habitat_burung" id="habitat_burung" data-error="Isi data dengan benar">
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        <div class="help-block with-errors" role="alert"></div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <p><b>Deskripsi Burung:</b></p>
                                    <div class="col-md-15">
                                        <input type="text" class="form-control" required name="deskripsi" id="deskripsi" data-error="Isi kolom dengan benar">
                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        <div class="help-block with-errors" role="alert"></div>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <p><b>Gambar Burung:</b></p>
                                    <div class="col-md-15">
