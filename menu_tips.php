...
<body>        
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb" style="background-color: #2B2B2B; font-family: 'Franklin Gothic Medium';">
            ...
            <li class="breadcrumb-item"  aria-current="page"><a href="menu_info.php" style="color: white">Tips</a></li>
        </ol>
    </nav>
    <!-- Breadcrumb -->
    ...
    <main role="main">
        <div class="container">
            <h2 class="text my-4 font-weight-bold" style="text-align: center;">Tips Perawatan Burung</h2>
        </div>
            ...
            <div class="container">
                <div class="row" id="quote-items">
                    ...
                    <div class="col-md-4 quote-item" id="quote-item" >
                            <a class="card mb-4 box-shadow text-center" href=<?php echo "\"detail_tips.php?id=".$data[0]."\""?>>
                            <img class="card-img-top" src="assets/uploads/tips/<?php echo $data['foto']; ?>" width="85px" height="200px">
                            <div class="card-img-overlay d-flex align-items-end justify-content-center px-0 py-0">
                                <h5 class="card-title my-0  flex-grow-1"
                                    style="color: white; background-color: black; opacity: 0.7;"><?php echo $data['judul_tips'] ?></h5>
                            </div>
                        </a>
