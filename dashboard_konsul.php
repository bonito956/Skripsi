            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <h1 class="m-0">Data Konsultasi</h1>
                    </div><!-- /.container-fluid -->
                </div>
                <!-- /.content-header -->
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead style="background-color: #343A40; color: #FFFFFF">
                                            <tr>
                                                ...
                                                <th>Email Konsultasi</th>
                                                <th>Subjek Konsultasi</th>
                                                <th>Aksi</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody>
                                            <tr data-widget="expandable-table" aria-expanded="false">
                                                ...
                                                <td><?php echo $value['email_konsulti'] ?></td>
                                                <td><?php echo $value['subjek_konsul'] ?></td>
                                                <td>
                                                    <a href="hapus_konsul.php?id_konsul=<?php echo $value['id_konsul'] ?>" type="button"> 
